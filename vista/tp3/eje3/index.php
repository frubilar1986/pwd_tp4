            ...
            <div class="card shadown-lg p-3 mb-2 bg-white">
                ...
                <div class="card-body">
                    <div class="justify-content-center border rounded-3 ">
                        ...
                        <form action="accion.php" method="post" id='tp3eje3' name="tp3eje3" class="needs-validation" data-toggle="validator" novalidate onsubmit="" enctype="multipart/form-data">
                            ...
                            <div class="container">
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="titulo" id="titulo" placeholder="titulo de pelicula" pattern="^[A-Za-z0-9 ]*$" autocomplete="off" required>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class='col-md-12'>
                                        <label for="formFileLg" class="form-label ">Portada de pelicula</label>
                                        <input type="file" class="form-control form-control-lg " id="fileUp" name="fileUp" accept="image/png,image/jpeg" required>
